...
const WeaknessAnalysis = ({ user }) => {
  ...
  const getTrendMessage = (trend) => {
    switch (trend) {
      ...
      case "improving":
        return "Good progress! Keep up the consistent practice.";
      case "stable":
        return "Steady performance. Consider challenging yourself more.";
      case "declining":
        return "Performance is declining. Focus on weak areas.";
      case "declining-fast":
        return "Significant decline detected. Time for intensive practice.";
      case "insufficient-data":
        return "Take more quizzes to see your progress trend.";
      default:
        return "Keep practicing to establish your performance trend.";
    }
  };
  ...
  if (
    !analysis ||
    (!analysis.weakAreas?.length && !analysis.recommendations?.length)
  ) {
    return (
      <div className="text-center py-12">
        <div className="text-6xl mb-4">📊</div>
        ...
        <p className="text-gray-400 mb-4">
          Take a few more quizzes to get personalized insights and
          recommendations.
        </p>
      ...
      {analysis.overallProgress && (
        <div className="bg-white/5 rounded-lg p-6 border border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            ...
            <div className="text-center">
              <div
                className={`text-2xl font-bold ${getTrendColor(analysis.overallProgress.recentTrend)}`}
              >
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-green-400">
                {analysis.overallProgress.improvementRate
                  ? `+${analysis.overallProgress.improvementRate}%`
                  : "N/A"}
              </div>
          ...
          <div
            className={`text-sm p-3 rounded-lg border ${getTrendColor(analysis.overallProgress.recentTrend)} bg-white/5`}
          >
        ...
        <div className="flex border-b border-white/10">
          {[
            ...
            },
            {
              ...
              icon: "🎯",
              count: analysis.weakAreas?.length || 0,
            },
            {
              id: "strengths",
            ...
            },
            {
              ...
              icon: "🔍",
              count: analysis.detailedInsights?.length || 0,
            },
          ].map((tab) => (
            <button
              key={tab.id}
              ...
              {analysis.recommendations?.length > 0 ? (
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span
                              className={`px-2 py-1 text-xs rounded-full border ${getPriorityColor(rec.priority)}`}
                            >
                              {rec.priority}
                            </span>
                          </div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-300">
                    Great job! No urgent recommendations at the moment.
                  </p>
            ...
            <div className="space-y-4">
              ...
              {analysis.weakAreas?.length > 0 ? (
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`px-2 py-1 text-xs rounded-full border ${getPriorityColor(weak.priority > 50 ? "high" : weak.priority > 25 ? "medium" : "low")}`}
                          >
                            {weak.priority > 50
                              ? "High Priority"
                              : weak.priority > 25
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-3 text-sm">
                        ...
                        <div>
                          ...
                          <span
                            className={`ml-2 ${parseFloat(weak.improvementRate) >= 0 ? "text-green-400" : "text-red-400"}`}
                          >
                            {parseFloat(weak.improvementRate) >= 0 ? "+" : ""}
                            {weak.improvementRate}%
                          </span>
                        </div>
                      </div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400 text-sm">
                    All your categories are performing well.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="space-y-4">
              ...
              {analysis.strengths?.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400 text-sm">
                    Take more quizzes to see which categories you excel in.
                  </p>
                </div>
              )}
            </div>
              ...
              {analysis.detailedInsights?.length > 0 ? (
                <div className="space-y-4">
                  {analysis.detailedInsights.map((insight, index) => (
                    <div
                      key={index}
                      className={`rounded-lg p-4 border ${insight.positive ? "bg-green-500/10 border-green-500/30" : "bg-blue-500/10 border-blue-500/30"}`}
                    >
                      <div className="flex items-start gap-3">
                ...
                <div className="text-center py-8">
                  <div className="text-4xl mb-3">🔍</div>
                  <p className="text-gray-300">
                    Take more quizzes to unlock detailed insights!
                  </p>
                  <p className="text-gray-400 text-sm">
                    We'll analyze patterns in your performance and study habits.
                  </p>
                </div>
              )}
            </div>
