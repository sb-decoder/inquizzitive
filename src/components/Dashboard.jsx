        ...
        <div className="dashboard-content p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
          ...
          {activeTab === 'history' && (
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-white mb-4">Recent Quiz Results</h3>
              {quizHistory.length === 0 ? (
                <div className="text-center py-12">
                  <div className="text-6xl mb-4">📝</div>
                  <h3 className="text-xl font-semibold text-gray-300 mb-2">No Quiz History</h3>
                  <p className="text-gray-400">Take your first quiz to see your results here!</p>
                </div>
              ) : (
                <div className="grid gap-4">
                  {quizHistory.map((quiz) => {
                    ...
                    return (
                      <div key={quiz.id} className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-gray-400">{quiz.difficulty}</span>
                          </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          <div>
                            ...
                            <div className={`font-semibold ${getScoreColor(quiz.score_percentage)}`}>
                          ...
                          <div>
                            ...
                            <div className="font-semibold text-white">
                              {quiz.time_taken ? formatTime(quiz.time_taken) : 'N/A'}
                            </div>
                          </div>
                          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                <div className="bg-white/5 rounded-lg p-4 border border-white/10 text-center">
                  <div className="text-2xl font-bold text-purple-400">{stats.totalQuizzes}</div>
                ...
                <div className="bg-white/5 rounded-lg p-4 border border-white/10 text-center">
                  <div className="text-2xl font-bold text-yellow-400">{stats.totalCorrect}</div>
                      ...
                      <div key={category} className="bg-white/5 rounded-lg p-4 border border-white/10">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            <div className={`font-semibold ${getScoreColor(data.averageScore)}`}>
                              {data.averageScore}%
                            </div>
                            <div className="text-xs text-gray-400">{data.count} quizzes</div>
                          </div>
                        </div>
                      </div>
                    ))}
              ...
              {Object.keys(stats.difficultyStats).length > 0 && (
                <div>
                  <h4 className="text-lg font-semibold text-white mb-4">Performance by Difficulty</h4>
                  <div className="grid gap-3">
              ...
              <div className="bg-white/5 rounded-lg p-6 border border-white/10">
                ...
                {stats && (
                  <div className="mt-6 pt-6 border-t border-white/10">
                    <h5 className="text-lg font-semibold text-white mb-4">Quick Stats</h5>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="text-center">
                        <div className="text-xl font-bold text-purple-400">{stats.totalQuizzes}</div>
                      ...
                      <div className="text-center">
                        <div className="text-xl font-bold text-blue-400">{Object.keys(stats.categoryStats).length}</div>
