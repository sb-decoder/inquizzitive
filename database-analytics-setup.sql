-- Add new tables for weakness analysis and recommendations
-- This extends the existing database schema

-- Create user_analytics table to store computed analytics
...
-- Create study_streaks table to track daily practice
...
-- Create bookmarks table for saving interesting questions
...
-- Create achievement_progress table for gamification
